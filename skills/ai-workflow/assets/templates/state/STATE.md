...
- **Project idea:** <one-line idea + target users>
- **Stakes:** <throwaway | mvp | platform>   <!-- dials the depth of every stage -->
- **Conversation language:** <detected or asked once>
- **Created:** <YYYY-MM-DD>
...
| # | Stage | Status | Notes |
|---|-------|--------|-------|
| 1 | Discovery | `in_progress` | — (active) |
| 2 | Scope | `pending` | — |
| 3 | Brand | `pending` | — |
